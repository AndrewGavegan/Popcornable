var data = {
  'results': [
    ...
    },
    {
      ...
      'popularity': 81.576,
      'poster_path': '/jTYWYHpcWLLnrlbueigHZeMuvaJ.jpg',
    ...
    {
      'adult': false,
      'backdrop_path': '/7JzyYQnIpHdoMR3PtTwM5xaLA20.jpg',
      ...
      'popularity': 49.724,
      'poster_path': '/2o3zJ9uzILXljXbSLrwoo5CxmaW.jpg',
    ...
    {
      'adult': false,
      'backdrop_path': '/oIClM946YzrDDNdhV4E6f0Z9nbx.jpg',
      'genre_ids': [35],
      'id': 87818,
      'media_type': 'movie',
      'original_language': 'en',
      ...
      'popularity': 51.56,
      'poster_path': '/jqEzrpKhc7KMuoHlcAVcYoK7T7O.jpg',
    ...
    {
      'adult': false,
      'backdrop_path': '/kttkW0qMv4quwRH5a59gQMFrpl2.jpg',
      'genre_ids': [35],
      'id': 4258,
      'media_type': 'movie',
      'original_language': 'en',
      ...
      'popularity': 72.018,
      'poster_path': '/r2Jwo4Eoax0oOnsU5qcXv0ea0Q8.jpg',
    ...
    },
    {
      ...
      'overview': 'Back at home, Chuck relates the island shenanigans of his larva pals Red and Yellow to a skeptical reporter in this movie sequel to the hit cartoon.',
      'popularity': 88.335,
    ...
    },
    {
      ...
      'popularity': 62.117,
      'poster_path': '/eagJEILa8SqWZV1mhm4HToVy8e.jpg',
    ...
    {
      'adult': false,
      'backdrop_path': '/6hStN2cnRgGM11IYKp6cRTFE78c.jpg',
      'genre_ids': [35],
      'id': 4257,
      'media_type': 'movie',
      'original_language': 'en',
      ...
      'popularity': 50.357,
      'poster_path': '/jvMnognzI6wrn7OJFla8MLLYep7.jpg',
    ...
    },
    {
      ...
      'popularity': 82.165,
      'poster_path': '/nLvLlyODv0StiSYDeCTE5KnN0Gi.jpg',
...
var res = {
  movies: data.results.map(function (v) {
    return {
      name: v.title,
      year: v.release_date.substring(0, 4),
      genre: v.genre_ids,
      image_url: 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2' + v.poster_path
    };
  })
};
console.log(res);